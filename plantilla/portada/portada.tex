	...
	\begin{center}
		\begin{tabular}{c c}
			\begin{tabular}{c}
				...
				\textbf{Soto Felix}\\ Ramses Misael \\ \texttt{l23330117@hermosillo.tecnm.mx} \\ Teléfono: (opcional)
			\end{tabular} &
			\begin{tabular}{c}
			...
			\begin{tabular}{c}
				...
				\textbf{}\\ Nombre3 \\ \texttt{l23330117@hermosillo.tecnm.mx} \\ Teléfono: (opcional)
			\end{tabular} &
			\begin{tabular}{c}
